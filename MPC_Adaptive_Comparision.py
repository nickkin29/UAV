...
ax.plot(statesTotal_x_mpc,statesTotal_y_mpc,statesTotal_z_mpc,'g',label='mpc_trajectory')
...
plt.subplot(3, 1, 1)
plt.plot(t, (X_ref - statesTotals_mpc[:, 0]), 'g', linewidth=1, label='X(mpc) Error')
...
plt.subplot(3, 1, 2)
plt.plot(t, (Y_ref - statesTotals_mpc[:, 1]), 'g', linewidth=1, label='Y(mpc) Error')
...
plt.subplot(3, 1, 3)
plt.plot(t, (Z_ref - statesTotals_mpc[:, 2]), 'g', linewidth=1, label='Z(mpc) Error')
...
plt.plot(t_angles, statesTotal_mpc[:, 0], 'g', linewidth=1, label='X(mpc)')
...
plt.plot(t_angles, statesTotal_mpc[:, 1], 'g', linewidth=1, label='Y(mpc)')
...
plt.plot(t_angles, statesTotal_mpc[:, 2], 'g', linewidth=1, label='Z(mpc)')
