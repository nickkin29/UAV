...
import support_files_drone_constraints_no_noise as sfd_constraints
# import point_tracking as sfd_constraints
...
statesTotals = [states]  # Track all states
...
if no_plots==1:
    ...
    # plt.savefig("Default_Tuned.png", dpi=300, bbox_inches="tight")
    ax.legend()
    plt.show()
    ...
    # plt.savefig("Err_Default_Tuned", dpi=300, bbox_inches="tight")
